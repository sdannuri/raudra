 ...
 * TCExam title.
 */
define ('K_TCEXAM_TITLE', 'Raudra');

/**
 * TCExam description.
 */
define ('K_TCEXAM_DESCRIPTION', 'Raudra - Raudra IT services');

/**
 * TCExam Author.
 */
define ('K_TCEXAM_AUTHOR', 'Raudra - Raudra IT services');
 ...
 */
define ('K_TCEXAM_KEYWORDS', 'Raudra Exam, eExam, e-exam, web, exam');
