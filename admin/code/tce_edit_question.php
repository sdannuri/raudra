...
else if (isset($_REQUEST['answer_question_id'])){
    $question_id = intval($_REQUEST['answer_question_id']);
}
else {
    $question_id = 0;
}
...
switch($menu_mode) {
    ...
    case 'delete':{
        if(isset($_REQUEST["create_question_form"])){
...
echo '<textarea cols="56" rows="5" name="question_description" id="question_description" onselect="FJ_update_selection(document.getElementById(\'form_questioneditor\').question_description)" title="'.$l['h_question_description'].'"';
if (K_ENABLE_VIRTUAL_KEYBOARD) {
...
if (K_ENABLE_QUESTION_EXPLANATION) {
    ...
    echo '<textarea cols="56" rows="5" name="question_explanation" id="question_explanation" onselect="FJ_update_selection(document.getElementById(\'form_questioneditor\').question_explanation)" title="'.$l['h_explanation'].'"';
    if (K_ENABLE_VIRTUAL_KEYBOARD) {
        echo ' class="keyboardInput"';
    }
...
//echo '<legend title="'.$l['h_question_type'].'" class="label-position">'.$l['w_type'].'</legend>'.K_NEWLINE;
...
echo '<input type="hidden" name="create_question_form" id="create_question_form" value="1" />'.K_NEWLINE;
