...
<div class="sub-container import-user-container">
<div class="sub-heading"><h1>Upload User</h1></div>
<div>&nbsp;</div>
<div class="tceformbox-user-body">
    
<form action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="post" enctype="multipart/form-data" id="form_importusers">


    <span class="label"><label for="userfile"><?php echo $l['w_upload_file'].': &nbsp;'; ?></label></span>
<span class="formw">
