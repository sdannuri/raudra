...
switch($menu_mode) {
	...
	case 'delete':{
		if(isset($_REQUEST["anwsers_from"])) {
				...
				<div class="confirmbox">
					<form action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="post" enctype="multipart/form-data"
						...
						<div>
							...
							<input type="hidden" name="subject_module_id" id="subject_module_id"
								   value="<?php echo $subject_module_id; ?>"/>
							<input type="hidden" name="question_subject_id" id="question_subject_id"
								   value="<?php echo $question_subject_id; ?>"/>
							<input type="hidden" name="answer_question_id" id="answer_question_id"
								   value="<?php echo $answer_question_id; ?>"/>
							<input type="hidden" name="answer_description" id="answer_description"
								   value="<?php echo $answer_description; ?>"/>
							<input type="hidden" name="answer_explanation" id="answer_explanation"
								   value="<?php echo $answer_explanation; ?>"/>
							<?php
...
echo '<div class="row"></div>'.K_NEWLINE;
...
echo '<textarea cols="56" rows="5" name="answer_description" id="answer_description" onselect="FJ_update_selection(document.getElementById(\'form_answereditor\').answer_description)" title="'.$l['h_answer'].'"';
if (K_ENABLE_VIRTUAL_KEYBOARD) {
...
if (K_ENABLE_ANSWER_EXPLANATION) {
	...
	echo '</span>';
	echo '</span>'.K_NEWLINE;
	echo '<span id="explanationarea" class="formw edit_box" style="display:none; margin-top:10px;">'.K_NEWLINE;
	echo '<textarea cols="56" rows="5" name="answer_explanation" id="answer_explanation" onselect="FJ_update_selection(document.getElementById(\'form_answereditor\').answer_explanation)" title="'.$l['h_explanation'].'"';
	if (K_ENABLE_VIRTUAL_KEYBOARD) {
		echo ' class="keyboardInput"';
	}
...
echo '<input type="hidden" name="anwsers_from" id="anwsers_from" value="anwsers_from" />'.K_NEWLINE;
echo '</div>'.K_NEWLINE;
