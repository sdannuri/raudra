...
echo '<div class="sub-heading"><h1>Create User</h1></div>';
echo '<div>&nbsp</div>';
...
echo getFormRowTextInput('newpassword', $l['w_password'], $l['h_password'], ' ('.$l['d_password_lenght'].')', '', '^([a-zA-Z0-9_(){}$%^?=*@./#&+-]{8,32})$', 255, false, false, true);
