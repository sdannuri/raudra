...
echo '<div class="sub-container qa-container">'.K_NEWLINE;
echo '<div class="sub-heading"><h1>Show Results</h1></div>';
...
echo '<a href="#" onclick="'.$jsaction.'" class="xmlbutton" title="'.$l['w_select'].'">Select Test</a>';
...
echo '<a href="#" onclick="'.$jsaction.'" class="xmlbutton" title="'.$l['w_select'].'">Select User</a>';
