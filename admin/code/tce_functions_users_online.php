...
function F_list_online_users($wherequery, $order_field, $orderdir, $firstrow, $rowsperpage) {
    ...
    echo '<div class="sub-container-tableForm">' . K_NEWLINE;
    echo '<div class="sub-heading-tableForm"><h1>Online Table</h1></div>' . K_NEWLINE;
    echo '<br/><table width="100%"><tr><td width="20%"></td>' . K_NEWLINE;
    echo '<td width="60%">' . K_NEWLINE;
    ...
    echo '</td>' . K_NEWLINE;
    echo  '<td width="20%"></td></tr></table><br/>' . K_NEWLINE;
