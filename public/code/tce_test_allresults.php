...
echo '<div class="changeEmail">'.K_NEWLINE;
echo '<div class="changeEmailHeader"><h1>User Results</h1></div>';
echo '<div>&nbsp</div>';
...
echo '<span class="formw">'.K_NEWLINE;
echo '<input type="submit" name="selectcategory" id="selectcategory"  class="ctn-btn" value="'.$l['w_select'].'" />'.K_NEWLINE;
echo '</span>'.K_NEWLINE;
echo '</div>'.K_NEWLINE;
