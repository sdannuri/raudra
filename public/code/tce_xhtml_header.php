...
//jquery ui
echo '<link rel="stylesheet" href="'.K_JQUERY_CSS.'">'.K_NEWLINE;
echo '<link rel="stylesheet" href="'.K_CALC_CSS.'">'.K_NEWLINE;
echo '<script src="'.K_JQUERY.'"></script>'.K_NEWLINE;
echo '<script src="'.K_JQUERY_UI.'"></script>'.K_NEWLINE;
echo '<script src="'.K_DIALOG_EXTEND.'"></script>'.K_NEWLINE;
echo '<script src="'.K_CUSTOM.'"></script>'.K_NEWLINE;
echo '<script src="'.K_CALC.'"></script>'.K_NEWLINE;
//default css
