...
echo '<div class="reg-container">'.K_NEWLINE;
echo '<div class="reg-heading">User Registration</div>';
echo '<div class="tceformbox-reg-body">'.K_NEWLINE;
...
echo getFormRowTextInput('newpassword', $l['w_password'], $l['h_password'], ' ('.$l['d_password_lenght'].')', '', '^([a-zA-Z0-9_(){}$%^?=*@./#&+-]{8,32})$', 255, false, false, true, showRequiredField(2));
...
echo '</div>'.K_NEWLINE;
echo '<div class="spacing_register">&nbsp;&nbsp;&nbsp;&nbsp;</div>'.K_NEWLINE;
require_once('../code/tce_page_footer.php');
