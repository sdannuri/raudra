<div id="online_calculator" title="Scientific Calculator">
    <div id="keyPad" class="calc_container">
        <!--<div class="calc_close" id="closeButton">X</div>-->
        <input type="text" id="keyPad_UserInput1" class="keyPad_TextBox1" readonly="readonly" style="padding: 0 10px;width:430px;" />
        <div class="text_container">
            <input type="text" id="keyPad_UserInput" class="keyPad_TextBox" maxlength="30" readonly="readonly" style="padding: 0 10px;width:430px;" />
            <span id="memory" class="memoryhide"><font size="2">M</span>
        </div>
        <div class="clear"></div>
        <div class="left_sec">
            <div class="calc_row clear" style="padding:1px;">
                <a href="#nogo" id="keyPad_btnMod" class="keyPad_btnBinaryOp">mod</a>
                <div class="degree_radian">
                    <input type="radio" name="degree_or_radian" value="deg" checked="checked"/><label>Deg</label>
                    <input type="radio" name="degree_or_radian" value="rad" /><label>Rad</label>
                </div>
    ...
    <div id="calculator-help" class="calculator-help" style="display:none;">
    ...
    <a href="javascript:void(0);" class="help-link" style="float:right;text-decoration: none;">Help</a>
    <a href="javascript:void(0);" class="calculator-link" style="display:none;float:right;text-decoration: none;">Back</a>
</div>