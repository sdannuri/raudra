...
echo '<div class="container changeEmail">'.K_NEWLINE;

echo '<div class="gsoformbox">'.K_NEWLINE;
echo '<div class="changeEmailHeader"><h1>Change Password</h1></div>';
...
echo getFormRowTextInput('newpassword', $l['w_new_password'], $l['h_password'], ' ('.$l['d_password_lenght'].')', '', '^([a-zA-Z0-9_(){}$%^?=*@./#&+-]{8,32})$', 255, false, false, true, '');
