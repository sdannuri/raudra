...
define('K_JQUERY_CSS',K_PATH_STYLE_SHEETS.'jquery-ui.css');
define('K_CALC_CSS',K_PATH_STYLE_SHEETS.'calclayout.css');
/**
 * Paths to js
 *  */
define('K_JQUERY',K_PATH_JSCRIPTS.'jquery-1.12.4.js');
define('K_JQUERY_UI',K_PATH_JSCRIPTS.'jquery-ui.js');
define('K_DIALOG_EXTEND',K_PATH_JSCRIPTS.'jquery.dialogextend.min.js');
define('K_CUSTOM',K_PATH_JSCRIPTS.'custom.js');
define('K_CALC',K_PATH_JSCRIPTS.'oscZenoedited.js');
