...
function F_loginForm($faction, $fid, $fmethod, $fenctype, $username) {
	...
	$str .= '<div class="tceformbox-login-box">';
        $str .= '<div class="login-heading"><h1>Login</h1></div>';
        $str.='<div class="login-body">';
	...
	// buttons
	$str .= '<div class="row">'.K_NEWLINE;
	$str .= '<input type="submit" name="login" id="login" value="'.$l['w_login'].'" title="'.$l['h_login_button'].'" class="login-btn" />'.K_NEWLINE;
